...
panglao = sc.read_h5ad('/home/iman/scBERT/data/panglao_human.h5ad')
data = sc.read_h5ad('/home/iman/scBERT/data/Zheng68K.h5ad')
...
new.write('/home/iman/scBERT/data/Zheng68K_preprocessed_data.h5ad')
