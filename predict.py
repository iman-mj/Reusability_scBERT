...
parser.add_argument("--unassign_thres", type=float, default=0.1, help='The confidence score threshold for novel cell type annotation.')
parser.add_argument("--pos_embed", type=bool, default=True, help='Using Gene2vec encoding or not.')
parser.add_argument("--data_path", type=str, default='/home/iman/scBERT/data/Test_Neurips.h5ad', help='Path of data for predicting.')
parser.add_argument("--model_path", type=str, default='/home/iman/scBERT/data/Saved_model/finetuNeneurips_best.pth', help='Path of finetuned model.')
...
with open('/home/iman/scBERT/code/neurips_label_dict.pkl', 'rb') as fp:
    label_dict = pkl.load(fp)
with open('/home/iman/scBERT/code/neurips_label.pkl', 'rb') as fp:
    label = pkl.load(fp)
